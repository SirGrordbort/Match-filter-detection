...
velocity model adjusted by Toby Messerli
"""
import logging
...
VELOCITIES = [  # white island velocities Eberhart-Phillips et al., 2010),
    Velocity(-1.0, 2.07),
    Velocity(3.0, 5.58),
    Velocity(8.0, 6.21),
    Velocity(15.0, 6.63),
...
def seisan_hyp(
    ...
    e_back = event_back[0]
    e_back_or = e_back.origins[0]
    event_out.origins[0] = e_back_or
